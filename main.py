...
def get_understand_and_execute_task():
    ...
    return Task(
        description=(
            ...
            "9. 🏢 **إدارة CRM (HubSpot, Salesforce, Zoho, ...)**: جلب أو البحث في بيانات العملاء باستخدام CRM Agent.\n"
            "10. 🤖 **أسئلة واستفسارات Siyadah**: يتم تمريرها إلى وكيل المساعد الذكي Siyadah Intelligent Agent.\n\n"
            ...
            "6. في *قاعدة البيانات*: تنفيذ بعد التحقق من قيود البريد.\n"
            "7. في *الملفات*: إنشاء الملف عبر File Creator Agent وحفظه في مجلد 'files/'.\n"
            "8. في *إدارة CRM*: استدعاء CRM Agent لجلب أو البحث في العملاء.\n"
            "9. في استفسارات Siyadah: يتم استدعاء الوكيل المعرفي.\n"
            "10. الأسئلة المباشرة: إجابة مقتضبة.\n"
            "11. التأكيد فقط في حالة الأوامر التنفيذية.\n"
            "12. التعامل مع الأخطاء بلغة مهذبة ومختصرة.\n\n"
